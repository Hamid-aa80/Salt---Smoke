...
To create a premium smokehouse dining experience in Watford that blends fire‑kissed cooking, cinematic ambience, and intimate hospitality — giving guests a place that feels warm, luxurious, and unforgettable.

### Expanded Purpose

- Deliver a signature fire‑kissed food experience  
Bringing authentic smokehouse flavours with a refined, modern British twist.

- Create a cinematic dining atmosphere  
Using dark‑premium lighting, warm bokeh, and fire‑driven visuals to make every visit feel like a scene.

- Offer a romantic, intimate space for couples  
A place where date nights feel special, warm, and elevated.

- Build a recognisable luxury brand identity  
Through consistent visuals, tone, storytelling, and premium sensory design.

- Strengthen Watford’s dining culture  
By introducing a unique, high‑quality smokehouse concept not currently available in the area.
...
![primary](README-img/primary.png)

![light](README-img/light.png)

![dark](README-img/dark.png)

## Contrast Checker

![Pink](README-img/Contrast-primary.png)
